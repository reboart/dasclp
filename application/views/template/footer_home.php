  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>PC IPNU IPPNU CILACAP</h3>
            <p>
              A108 Adam Street <br>
              New York, NY 535022<br>
              United States <br><br>
              <strong>Phone:</strong> +62 8589 55488 55<br>
              <strong>Email:</strong> info@pelajarnucilacap.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Histories</a></li>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
         &copy; Copyright  <?= date('Y');?> <strong><span>IPNU CILACAP</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          Design by <a href="https://reboart.com/"><strong>RB</strong></a>
        </div>
      </div>
